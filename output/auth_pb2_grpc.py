...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateUser = channel.unary_unary(
                ...
                request_serializer=auth__pb2.ValidateUserRequest.SerializeToString,
                response_deserializer=auth__pb2.ValidateUserResponse.FromString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ValidateUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.ValidateUserRequest.FromString,
                    response_serializer=auth__pb2.ValidateUserResponse.SerializeToString,
            ),
...
class AuthService(object):
    ...
    def ValidateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/ValidateUser',
            auth__pb2.ValidateUserRequest.SerializeToString,
            auth__pb2.ValidateUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
